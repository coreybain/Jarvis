 ...
 * Supports legacy (~/.jarvis/worktrees/{projectId}/{chatId}/) and
 * new format (~/.jarvis/worktrees/{projectName}/{worktreeFolder}/).
 *
...
export function resolveProjectPathFromWorktree(
  ...
  const worktreeMarker = path.join(".jarvis", "worktrees")
  ...
  try {
    ...
    // Path format: /Users/.../.jarvis/worktrees/{projectSlug}/{worktreeFolder}
    const worktreeBase = path.join(os.homedir(), ".jarvis", "worktrees")

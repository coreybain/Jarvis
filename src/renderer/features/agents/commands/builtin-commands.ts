...
2. Create the file .jarvis/worktree.json with setup commands
...
Example output for .jarvis/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .jarvis/worktree.json with the appropriate setup commands.`,
}
